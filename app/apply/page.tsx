        ...
        <main className="container mx-auto px-4 py-16 relative z-10">
          <ScrollReveal direction="up" duration={800}>
            <div className="text-center mb-12">
              <div className="w-20 h-20 bg-gradient-to-br from-red-600 to-red-700 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-2xl shadow-red-900/50">
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed">
                ...
                <span className="text-red-400 font-semibold">elite alliance</span>. We're looking for quality
                communities that share our vision of growth and collaboration.
              </p>
            </div>
          </ScrollReveal>
            ...
            <Card className="max-w-2xl mx-auto bg-gradient-to-br from-gray-900 to-black border-red-900/30 shadow-2xl shadow-red-900/20">
              ...
              <CardContent>
                <form action={submitApplication} className="space-y-6">
                  <ScrollReveal direction="right" duration={600} delay={400}>
                  ...
                  <ScrollReveal direction="right" duration={600} delay={600}>
                    <div className="space-y-2">
                  ...
                  <ScrollReveal direction="left" duration={600} delay={700}>
                    <div className="space-y-2">
                  ...
                  <ScrollReveal direction="right" duration={600} delay={800}>
                    <div className="space-y-2">
                  ...
                  <ScrollReveal direction="left" duration={600} delay={900}>
                    <div className="space-y-2">
                  ...
                  <ScrollReveal direction="up" duration={600} delay={1000}>
                    <Button
                      type="submit"
                      size="lg"
          ...
          <ScrollReveal direction="fade" duration={800} delay={1200}>
